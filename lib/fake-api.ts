...
export const fakeMembers: Member[] = [
  ...
  },
  {
    ...
    phone: "(11) 99999-0007",
    cpf: "111.222.333-07",
    birthDate: "1990-05-28", // Alterado para 28/05/1990
    address: "Rua São Bento, 123",
    city: "São Paulo",
    state: "SP",
    zipCode: "01010-000",
    maritalStatus: "solteiro",
    ...
    ministry: "Jovens",
    photo: "/placeholder.svg?height=100&width=100&query=young+man+church",
    isActive: true,
    notes: "Líder de célula dos jovens",
  },
  {
    id: "8",
    name: "Beatriz Santos",
    ...
    phone: "(11) 99999-0008",
    cpf: "222.333.444-08",
    birthDate: "1985-01-29", // Quinta-feira desta semana
    address: "Av. Rebouças, 456",
    city: "São Paulo",
    state: "SP",
    zipCode: "05401-000",
    maritalStatus: "casado",
    baptized: true,
    memberSince: "2012-07-15",
    ministry: "Louvor",
    photo: "/placeholder.svg?height=100&width=100&query=woman+singer+church",
    isActive: true,
    notes: "Vocalista do grupo de louvor",
  },
  {
    id: "9",
    name: "Gabriel Costa",
    ...
    phone: "(11) 99999-0009",
    cpf: "333.444.555-09",
    birthDate: "1995-01-31", // Sábado desta semana
    ...
    maritalStatus: "solteiro",
    baptized: true,
    memberSince: "2019-09-20",
    ministry: "Tecnologia",
    photo: "/placeholder.svg?height=100&width=100&query=young+man+tech+church",
    isActive: true,
