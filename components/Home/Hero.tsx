    ...
    <section className="hero-bg flex items-center justify-center text-white relative min-h-screen pt-24 pb-16">
      <div className="container mx-auto px-6 text-center relative z-10">
        <h1
          ...
          data-aos="fade-up"
        >
          A Revolução na Gestão de Igrejas Está a Chegar.
        </h1>
        <p
          ...
          data-aos-delay="200"
        >
          Prepare-se para uma gestão simplificada com uma plataforma poderosa e
          intuitiva. O MyChurch será lançado com um plano gratuito para sempre.
        </p>
