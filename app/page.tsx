                  ...
                  <div className="relative z-10">
                    <div className="mb-8">
                      ...
                      <div className="relative w-24 h-24 mx-auto mb-6">
                        ...
                        <div className="relative w-full h-full bg-gradient-to-br from-primary/20 to-primary/10 rounded-full flex items-center justify-center border border-primary/20">
                      ...
                      <p className="text-lg md:text-xl text-gray-600 mb-6 max-w-2xl mx-auto leading-relaxed">
                        Estamos nos últimos ajustes para trazer a melhor experiência de gestão para sua igreja
                      </p>
                    </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="max-w-md mx-auto">
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div className="bg-gradient-to-r from-primary to-primary/80 h-2 rounded-full w-[95%] relative overflow-hidden">
                      ...
                      <div className="flex flex-wrap justify-center gap-3">
                        ...
                        <div className="flex items-center gap-2 px-4 py-2 bg-blue-50 rounded-full border border-blue-100">
                          ...
                          <span className="text-sm font-medium text-blue-700">Cadastre-se para ser notificado</span>
                        </div>
                      </div>
                    </div>
                  </div>
