...
export  function ChapterModal({
  ...
  useEffect(() => {
    ...
    // Cleanup function: ensures scroll is unlocked when component unmounts or state changes
    return () => {
      if (typeof window !== "undefined" && document.body) {
        document.body.style.overflow = "";
      }
    };
  }, [open]); // This effect runs whenever the 'open' prop changes
