...
export default function CultoPage() {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-6">Acompanhar Culto</h1>

      {/* Status de conexão */}
      <div className="mb-4 flex items-center gap-2 text-sm">
        <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
        <span className="text-gray-600">Conectado ao sistema de culto</span>
      </div>
        ...
        {readings.length === 0 && !isLoading ? (
          <Card>
            <CardContent className="p-4 text-center">
              ...
              <p className="text-gray-500">Aguardando leituras bíblicas do culto...</p>
              <p className="text-xs text-gray-400 mt-1">As leituras aparecerão aqui quando o culto iniciar</p>
            </CardContent>
          </Card>
        ) : (
