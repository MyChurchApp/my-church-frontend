        ...
        <div className="flex items-center gap-2">
          ...
          {isAuthenticated && (
            <>
              ...
              <Dialog open={isNewPostModalOpen} onOpenChange={onCloseNewPostModal}>
                <DialogContent className="sm:max-w-md">
                  ...
                  <div className="space-y-4 py-4">
                    ...
                    <div className="flex gap-2 pt-4">
                      ...
                      <Button variant="outline" onClick={onCloseNewPostModal} className="flex-1">
                        Cancelar
                      </Button>
                    </div>
                  </div>
      ...
      {feedError && !isLoadingFeed && (
        <div className="text-center py-12">
          <div className="bg-red-50 border border-red-200 rounded-lg p-6 max-w-md mx-auto">
            ...
            <Button onClick={onLoadFeed} variant="outline" className="border-red-300 text-red-600 hover:bg-red-50">
              Tentar novamente
            </Button>
          </div>
        </div>
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-center gap-3">
                      <Avatar className="h-8 w-8 md:h-10 md:w-10">
                        ...
                        />
                        <AvatarFallback className="text-xs md:text-sm">{getInitials(item.member.name)}</AvatarFallback>
                      </Avatar>
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="px-2 py-1 text-xs bg-blue-100 text-blue-600 rounded-full">Publicação</span>
                        </div>
      ...
      <Dialog open={isEditModalOpen} onOpenChange={onCloseEditModal}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="flex gap-2 pt-4">
              <Button onClick={onSaveEdit} disabled={!editPostContent.trim() || isSavingEdit} className="flex-1">
                {isSavingEdit ? (
                  <>
                    <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2"></div>
                    Salvando...
              ...
              <Button variant="outline" onClick={onCloseEditModal} className="flex-1">
                Cancelar
              </Button>
            </div>
          </div>
